...
2.	I would also like to improve my programming skills throughout this course. Up until now I have programmed only data structures, algorithms and “applications” needed for the Computer Exam of OOP. But I don’t think that this is what real-life programs need to do. I guess they need to be easy to read and understand from the users, i.e. having a good gui and to not crash if something is typed wrong from the account, i.e. having a well-thought structure and being tested multiple times.
